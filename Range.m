...
%      RANGE, by itself, creates a new RANGE or raises the existing
%      singleton*.
%
%      H = RANGE returns the handle to a new RANGE or the handle to
%      the existing singleton*.
%
%      RANGE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in RANGE.M with the given input arguments.
%
%      RANGE('Property','Value',...) creates a new RANGE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before Range_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Range_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Range

% Last Modified by GUIDE v2.5 28-May-2013 12:13:55
...
function Range_OpeningFcn(hObject, eventdata, handles, varargin)
